...
**PhD**, Educational Psychology & Educational Technology \hfill Expected October 2020
...
**Learning Technology through Design** (Master’s, online, 3x) \hfill 2018-present
...
* \* Students playfully explore Google Apps, CMSs, screencasting tools, and file management systems.
* \* The semester-long project is to design a curriculum for an *online course module* of 3-5 interconnected lessons, which may include training sessions or non-traditional courses.
...
* \* Wrote course: *The Evolving Landscape of Educational Technology* (Master's)
